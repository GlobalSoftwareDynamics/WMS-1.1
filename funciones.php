...
function autocompletarDiferenteAUnaCondicion($table,$campo,$link,$campocondicion,$condicion){
    $array = '[';
    $query = mysqli_query($link,"SELECT * FROM {$table} WHERE {$campocondicion} != '{$condicion}'");
    $aux = 0;
    $numrows = mysqli_num_rows($query);
    while ($row = mysqli_fetch_array($query)){
        $aux++;
...
function autocompletarCondicion($table,$campo,$link,$campocondicion,$condicion){
	$array = '[';
	$query = mysqli_query($link,"SELECT * FROM {$table} WHERE {$campocondicion} = '{$condicion}'");
	$aux = 0;
	$numrows = mysqli_num_rows($query);
